...
<body ng-controller="MainCtrl">
    <div id="page" class="no-display">
        ...
        <main class="container" ng-controller="UpdateRouteCtrl">
            <div class="row">
                <h3>Edit route</h3>
            </div>
            <div class="row">
                ...
                <form ng-submit="saveRoute($event)">
                    <div class="col l3 m4 s12">
                        ...
                        <p>
                            <input type="checkbox" id="isActive" name="isActive" ng-model="data.isActive"/>
                            <label for="isActive">Active route</label>
                        </p>
                        <button class="register-submit btn waves-effect waves-light light-green darken-1" type="submit">Update route
                        </button>
                    </div>
                </form>
                <input type="hidden" value="${id}" id="route-id">
            </div>
